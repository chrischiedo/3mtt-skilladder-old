...
export default function AdminDashboard({ userData }) {
  ...
  const sfiaSkills =
    selected_career &&
    currentSkillLevel &&
    sfiaData[selected_career]?.evaluation_areas[currentSkillLevel]
      ? Object.entries(
          sfiaData[selected_career]?.evaluation_areas[
            currentSkillLevel
          ]
        )
      : [];
          ...
          <div className="col-span-1 md:col-span-8 grid grid-cols-8 gap-4 space-y-3">
            ...
            <div className="col-span-full bg-white border-1 rounded-lg p-6 grid grid-cols-1 md:grid-cols-1 lg:grid-cols-3 gap-6 min-h-96">
              ...
              <div className="space-y-6 col-span-1">
                <section>
                  ...
                  <div className="mt-6">
                    {self_ratings_json &&
                    Object.entries(self_ratings_json).length > 0
                      ? Object.entries(self_ratings_json)
                          .slice(0, 5)
                  ...
                  {self_ratings_json &&
                    Object.entries(self_ratings_json).length > 5 && (
                      <div className="mt-6">
                        <Link href="/self_rate">
                          <Button
                            size="lg"
                            variant="outline"
                            className="w-full text-base border-blue-500"
                          >
                            View All Skills
                          </Button>
                        </Link>
            ...
            {/* Second card */}
            {
              <div className="col-span-full  bg-white border-1 rounded-lg p-6 min-h-96">
                ...
                <section>
                  <h2 className="text-2xl font-semibold text-gray-700 gradient-text">
                    Professional Capability Result
                  ...
                  {selected_career && sfia_level_max >= 1 ? (
                    <Stepper
                      ...
                      active={
                        user_actions?.technical_assessment_taken ||
                        false
                      }
                    />
