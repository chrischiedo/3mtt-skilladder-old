...
export default function UserDashboard({ userData }) {
  ...
  const TECHNICAL_ASSESSMENT_TOTAL_SCORE =
    cohort === 'deeptech' ? 50 : 36;
      ...
      <div className="min-h-screen py-10 ">
        <div className="max-w-[1400px] lg:mx-auto grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div className="col-span-1 md:col-span-8 grid grid-cols-8 gap-4 space-y-3">
                      ...
                      <p className="font-bold text-xl">
                        ...
                        technical_score_open !== undefined
                          ? ` ${
                              technical_score_mcq +
                              technical_score_open
                            } / ${TECHNICAL_ASSESSMENT_TOTAL_SCORE}`
                          : displayMessage(
              ...
              <div className="space-y-6 col-span-1">
                <section>
                 ...
                 { <div className="flex flex-wrap gap-2 mt-6">
                    ...
                    {skills_extracted && skills_extracted.length > 15 && (
            ...
            {/* Second card */}
            {userData?.cohort != 'cohort_3' && <div className="col-span-full  bg-white border-1 rounded-lg p-6 min-h-96">
              {/* SFIA Results */}
               <section>
                <h2 className="text-2xl font-semibold text-gray-700 gradient-text">
                ...
                {selected_career && sfia_level_max >= 1 ? (
                  <Stepper
...
/> : displayMessage('Assessment not started.')
            ...
            {userData?.cohort != 'cohort_3' && <div className="col-span-full  bg-white border-1 rounded-lg p-6 min-h-64">
              {/* SFIA Breakdown */}
              <section>
                <h2 className="text-2xl font-semibold text-gray-700 gradient-text">
          ...
          <div className=" col-span-1 md:col-span-4 order-first lg:order-none">
            <div className="bg-white border-1 rounded-lg p-6">
              ...
              <div className="mt-6">
                <AssessmentSteps actions={user_actions} selectedCareer={userData?.selected_career} cohort={userData?.cohort} />
              </div>
